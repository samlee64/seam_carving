...
std::vector<FloatImage> morph(const FloatImage &im1, const FloatImage &im2, std::vector<Segment> &segsBefore, std::vector<Segment> &segsAfter, int N=1, float a=10.0, float b=1.0, float p=1.0, bool debug=false);
